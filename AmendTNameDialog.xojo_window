...
Begin Window AmendTNameDialog
   ...
   Visible         =   True
   Width           =   300
   Begin TextField TournamentNameDisplay
      AcceptTabs      =   False
      Alignment       =   0
      AutoDeactivate  =   True
...
#tag Events TournamentNameDisplay
	#tag Event
		Sub TextChange()
		  dim i as integer
...
#tag Events OKButton
	#tag Event
		Sub Action()
		  app.ratingsDB.SQLExecute("update tournament set tournament_name = '"+TournamentNameDisplay.Text.trim+"' where tournament_name = '"+MainWindow.TournamentPicker.Text+"'")
